            ...
            <!-- Content -->
				<div class="container-xxl flex-grow-1 container-p-y">
					<div class="row">
						...
						<!-- If others is empty show this -->
						<c:if test="${fn:length(files) < 1}">
							<div class="col-lg-12">
	           					<div class="d-flex justify-content-center mt-md-5 mt-5">
	           						<img src="../dashboard_assets/img/icons/unicons/paper.png" width="" height=""><br>
	           					</div>
	           					<h3 class="text-center mt-md-4 mt-4">No File Yet</h3>
							</div>
				  	 	</c:if>
				  	 	...
				  	 	<div class="row file_div">
				  	 		<c:if test="${fn:length(files) > 1}"><h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Files</span></h4></c:if>
					  	 	<c:forEach var="fileItem" items="${files}">
							        ...
							        <div class="card">
							          <div class="card-body">
							            ...
							            <h4 class="card-title mb-1">$4,679</h4> -->
									     ...
									     <span><a href = "<%= baseURL+"file_upload/"%>${fileItem.newName}" target="_blank"><img src="../dashboard_assets/img/icons/unicons/paper.png" class="w-100 mb-1 border border-primary p-3 border-2 rounded" width="" height="100px"></a></span>  
