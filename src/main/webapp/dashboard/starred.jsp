            ...
            <!-- Content -->
				<div class="container-xxl flex-grow-1 container-p-y">
					<div class="row folder_row">
						...
						<c:if test="${fn:length(starred_folder_list) < 1 and fn:length(starred_file_list) < 1}">
	           				<div class="col-lg-12">
					...
					<div class="row file_row">
		              	<c:if test="${fn:length(starred_file_list) > 1}"><h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Files</span></h4></c:if>
		              	<c:forEach var="fileItem" items="${starred_file_list}">
			                <div class="col-lg-2 col-md-3 col-6 mb-3">
						        <div class="card">
						          <div class="card-body">
