            ...
            <!-- Content -->
				<div class="container-xxl flex-grow-1 container-p-y">
					<div class="row">
						...
						<c:if test="${fn:length(audios) < 1}">
							<div class="col-lg-12">
	           					<div class="d-flex justify-content-center mt-md-5 mt-5">
	           						<img src="../dashboard_assets/img/icons/unicons/sound-bars.png" width="" height=""><br>
	           					</div>
				  	 	...
				  	 	<div class="row file_div">
					  	 	<!--<c:if test="${fn:length(audios) > 1}"><h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Audios</span></h4></c:if>-->
					  	 	<c:forEach var="audioItem" items="${audios}">
					  	 		<div class="col-lg-2 col-md-3 col-6 mb-3">
							        <div class="card">
							          <div class="card-body">
							            <div class="card-title d-flex align-items-start justify-content-between" style="margin-bottom: 0px !important;">
							               <div class="flex-shrink-0">
							                 <c:if test="${audioItem.favStatus == 1}" ><i class='bx bxs-star' style="color: #8588FF;"></i></c:if><c:if test="${audioItem.favStatus != 1}" ><i class='bx bxs-star' style="color: #FFFFFF;"></i></c:if>
							              </div>
							              <div class="dropdown mb-1">
							                ...
							                <div class="dropdown-menu" aria-labelledby="cardOpt6">
							                  ...
							                  <c:if test="${audioItem.favStatus == 1}" ><a class="dropdown-item" href="route_file?command=UNSTARRED&file_id=${audioItem.id}"><i class='bx bx-star'></i> Remove Starred</a></c:if>
					                  		  <c:if test="${audioItem.favStatus != 1}" ><a class="dropdown-item" href="route_file?command=STARRED&file_id=${audioItem.id}"><i class='bx bx-star'></i> Add to Starred</a></c:if>
							                  <a class="dropdown-item getlink" href="${audioItem.filePath}"><i class='bx bx-link-alt'></i> <span>Get Link</span></a>
							                  ...
							                  <input type="hidden" class="file_id" value="${audioItem.id}">
							                  <a class="dropdown-item" href="${audioItem.filePath}" download="${audioItem.displayName}"><i class='bx bx-cloud-download' ></i> Download</a>
							                  <hr>
							                  <a class="dropdown-item" href="route_file?command=TRASH&file_id=${audioItem.id}"><i class='bx bx-trash'></i> Delete</a>
							                </div>
							              </div>
							            </div>
