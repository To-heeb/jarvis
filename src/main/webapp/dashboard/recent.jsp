					...
					<div class="row">
	              	...
	              	<c:forEach var="folderItem" items="${folder_list}">
		              	...
		              	<div class="col-lg-2 col-md-3 col-6 mb-3">
		              		<a href="${folderItem.id}"><i class='bx bxs-star'></i><i class='bx bxs-folder' style='color:#8588ff; font-size: 155px;'></i></a>
			                  ...
			                  <a class="dropdown-item" href="route_folder?command=UNSTARRED&folder_id=${folderItem.id}"><i class='bx bx-star'></i> Remove Starred</a>
			                  <a class="dropdown-item" href="route_folder?command=STARRED&folder_id=${folderItem.id}"><i class='bx bx-star'></i> Add to Starred</a>
