...
<html
  ...
  data-assets-path="../dashboard_assets/"
...
>
  <head>
    ...
    <title>Register - Jarvis | Where Your Files are Secured and Save</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../dashboard_assets/img/favicon/favicon.ico" />
	...
	<link rel="stylesheet" href="../dashboard_assets/css/animate.css">
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="../dashboard_assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Make your file upload easy and fun!</p>
              ...
              <form id="formAuthentication" class="mb-3" action="register" method="POST">
                ...
                <button class="btn btn-primary d-grid w-100 my-4">Sign up</button>
              </form>
    	...
    	document.addEventListener("DOMContentLoaded", function(){
        	...
        	if(status == "success"){
        		Swal.fire({
        			  ...
        			  text: 'You can now login and 🛸 with us',
        			  showConfirmButton: false,
        			  showClass: {
        				    popup: 'animate__animated animate__fadeInDown'
        				  },
